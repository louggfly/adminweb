...
declare module 'fullcalendar/src/moment-ext' {
    ...
    let newMomentProto: any;
    let oldMomentProto: any;

    function oldMomentFormat(mom: any, formatStr?: any): any;
...
declare module 'fullcalendar/src/exports' {
    ...
    export {
        BusinessHoursInput, EventObjectInput, EventOptionsBase, OptionsInput
    } from 'fullcalendar/src/types/input-types';
    export {
        applyAll,
        debounce,
